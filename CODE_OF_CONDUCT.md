...
If you experience or witness unacceptable behavior, or have any other concerns, please contact the project team at: repo-maintainers@local (replace with an appropriate contact email).

All reports will be handled with discretion and with respect to the privacy of all involved.

## Enforcement Process

Instances of abusive, harassing, or otherwise unacceptable behavior may be reported by contacting the project team. The maintainers will review and respond to all reports in a timely manner.

Consequences for unacceptable behavior may include temporary or permanent bans from the project, removal of privileges, or other actions deemed appropriate by project maintainers.
