...
- `AppConfig.integrations.acoustid.api_key` (env: `CHORROSION_INTEGRATIONS__ACOUSTID__API_KEY`).
...
- `AppConfig.integrations.fanart.api_key` (env: `CHORROSION_INTEGRATIONS__FANART__API_KEY`).
...
- CLI entry and lifecycle: crates/chorrosion-cli/src/main.rs
- API surface and OpenAPI: crates/chorrosion-api/src/lib.rs
- App state/config: crates/chorrosion-application/src/lib.rs, crates/chorrosion-config/src/lib.rs
- Scheduler: crates/chorrosion-scheduler/src/*
- Data layer: crates/chorrosion-infrastructure/src/*
