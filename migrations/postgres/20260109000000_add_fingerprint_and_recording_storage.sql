...
ALTER TABLE tracks ADD COLUMN IF NOT EXISTS musicbrainz_recording_id TEXT;
ALTER TABLE tracks ADD COLUMN IF NOT EXISTS match_confidence DOUBLE PRECISION;
