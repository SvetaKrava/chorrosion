use anyhow::Result;
use lidarr_domain::{
    Album, AlbumId, AlbumStatus, Artist, ArtistId, ArtistStatus, MetadataProfile,
...
impl ArtistRepository for SqliteArtistRepository {
    ...
    async fn get_by_status(&self, status: ArtistStatus, limit: i64, offset: i64) -> Result<Vec<Artist>> {
...
impl AlbumRepository for SqliteAlbumRepository {
    async fn get_by_artist(&self, artist_id: ArtistId, limit: i64, offset: i64) -> Result<Vec<Album>> {
    ...
    async fn get_by_status(&self, status: AlbumStatus, limit: i64, offset: i64) -> Result<Vec<Album>> {
...
impl TrackRepository for SqliteTrackRepository {
    ...
    async fn get_by_artist(&self, artist_id: ArtistId, limit: i64, offset: i64) -> Result<Vec<Track>> {
